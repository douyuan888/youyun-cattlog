kubelet:
    ...
    command:
        ...
        {{- end }}
    image: youyun-private-harbor:9080/library/k8s:v1.6.6-rancher1-4
    volumes:
        - /run:/run
        - /var/run:/var/run
        - /sys:/sys:ro
...
kubectld:
    ...
    environment:
        ...
        LISTEN: ":8091"
    image: youyun-private-harbor:9080/library/kubectld:v0.6.8
    links:
        - kubernetes
...
rancher-kubernetes-agent:
    ...
    environment:
        KUBERNETES_URL: https://kubernetes.kubernetes.rancher.internal:6443
    image: youyun-private-harbor:9080/library/kubernetes-agent:v0.6.2
    privileged: true
    volumes:
...
rancher-ingress-controller:
    image: youyun-private-harbor:9080/library/lb-service-rancher:v0.7.4
    labels:
        {{- if eq .Values.CONSTRAINT_TYPE "required" }}
        io.rancher.scheduler.affinity:host_label: orchestration=true
        {{- end }}
...
rancher-kubernetes-auth:
    image: youyun-private-harbor:9080/library/kubernetes-auth:v0.0.4
    labels:
        {{- if eq .Values.CONSTRAINT_TYPE "required" }}
        io.rancher.scheduler.affinity:host_label: orchestration=true
        {{- end }}
