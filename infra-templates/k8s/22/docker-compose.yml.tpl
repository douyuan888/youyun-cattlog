kubelet:
    ...
    command:
        ...
        {{- end }}
    image: youyun-private-harbor:9080/library/k8s:v1.5.4-rancher1-4
    volumes:
        - /run:/run
        - /var/run:/var/run
        - /sys:/sys:ro
...
kubelet-unschedulable:
    ...
    image: youyun-private-harbor:9080/library/k8s:v1.5.4-rancher1-3
    volumes:
        - /run:/run
        - /var/run:/var/run
        - /sys:/sys:ro
...
kubectld:
    ...
    environment:
        ...
        LISTEN: ":8091"
    image: youyun-private-harbor:9080/library/kubectld:v0.6.0
    links:
        - kubernetes
...
rancher-ingress-controller:
    image: youyun-private-harbor:9080/library/lb-service-rancher:v0.6.1
    labels:
        {{- if eq .Values.CONSTRAINT_TYPE "required" }}
        io.rancher.scheduler.affinity:host_label: orchestration=true
        {{- end }}
