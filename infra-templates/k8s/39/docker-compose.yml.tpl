...
{{- $k8sImage:="youyun-private-harbor:9080/library/k8s:v1.8.5-rancher3" }}
{{- $etcdImage:="youyun-private-harbor:9080/library/etcd:v2.3.7-13" }}
{{- $kubectldImage:="youyun-private-harbor:9080/library/kubectld:v0.8.5" }}
{{- $etcHostUpdaterImage:="youyun-private-harbor:9080/library/etc-host-updater:v0.0.3" }}
{{- $k8sAgentImage:="youyun-private-harbor:9080/library/kubernetes-agent:v0.6.6" }}
{{- $k8sAuthImage:="youyun-private-harbor:9080/library/kubernetes-auth:v0.0.8" }}
{{- $ingressControllerImage:="youyun-private-harbor:9080/library/lb-service-rancher:v0.7.17" }}
