...
{{- $k8sImage:="youyun-private-harbor:9080/library/k8s:v1.7.7-rancher1" }}
{{- $etcdImage:="youyun-private-harbor:9080/library/etcd:v2.3.7-13" }}
{{- $kubectldImage:="youyun-private-harbor:9080/library/kubectld:v0.8.3" }}
...
{{- $ingressControllerImage:="youyun-private-harbor:9080/library/lb-service-rancher:v0.7.10" }}
