...
{{- $netManagerImage:="youyun-private-harbor:9080/library/network-manager:v0.7.19" }}
{{- $metadataImage:="youyun-private-harbor:9080/library/metadata:v0.9.5" }}
{{- $dnsImage:="youyun-private-harbor:9080/library/dns:v0.15.3" }}
